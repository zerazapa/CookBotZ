...
public class HandScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Mouse0) && !lClick)
        {
            lClick = true;
        }
    ...
    private IEnumerator SpawnDish()
    {
        ...
        if (isTouchingDish && !spawn10used && spawn9used && !isSpawningDish)
        {
            isSpawningDish = true;
        ...
        if (isTouchingDish && !spawn9used && spawn8used && !isSpawningDish)
        {
            isSpawningDish = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingDish && !spawn8used && spawn7used && !isSpawningDish)
        {
            isSpawningDish = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingDish && !spawn7used && spawn6used && !isSpawningDish)
        {
            isSpawningDish = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingDish && !spawn6used && spawn5used && !isSpawningDish)
        {
            isSpawningDish = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingDish && !spawn5used && spawn4used && !isSpawningDish)
        {
            isSpawningDish = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingDish && !spawn4used && spawn3used && !isSpawningDish)
        {
            isSpawningDish = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingDish && !spawn3used && spawn2used && !isSpawningDish)
        {
            isSpawningDish = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingDish && !spawn2used && spawn1used && !isSpawningDish)
        {
            isSpawningDish = true;
            yield return new WaitForSeconds(1f);
    ...
    private IEnumerator SpawnBread1()
    {
        ...
        if (isTouchingBread1 && !spawn10used && spawn9used && !isSpawningBread1)
        {
        ...
        if (isTouchingBread1 && !spawn9used && spawn8used && !isSpawningBread1)
        {
            isSpawningBread1 = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingBread1 && !spawn8used && spawn7used && !isSpawningBread1)
        {
            isSpawningBread1 = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingBread1 && !spawn7used && spawn6used && !isSpawningBread1)
        {
            isSpawningBread1 = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingBread1 && !spawn6used && spawn5used && !isSpawningBread1)
        {
            isSpawningBread1 = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingBread1 && !spawn5used && spawn4used && !isSpawningBread1)
        {
            isSpawningBread1 = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingBread1 && !spawn4used && spawn3used && !isSpawningBread1)
        {
            isSpawningBread1 = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingBread1 && !spawn3used && spawn2used && !isSpawningBread1)
        {
            isSpawningBread1 = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingBread1 && !spawn2used && spawn1used && !isSpawningBread1)
        {
            isSpawningBread1 = true;
            yield return new WaitForSeconds(1f);
    ...
    private IEnumerator SpawnBread2()
    {
        ...
        if (isTouchingBread2 && !spawn10used && spawn9used && !isSpawningBread2)
        {
        ...
        if (isTouchingBread2 && !spawn9used && spawn8used && !isSpawningBread2)
        {
            isSpawningBread2 = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingBread2 && !spawn8used && spawn7used && !isSpawningBread2)
        {
            isSpawningBread2 = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingBread2 && !spawn7used && spawn6used && !isSpawningBread2)
        {
            isSpawningBread2 = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingBread2 && !spawn6used && spawn5used && !isSpawningBread2)
        {
            isSpawningBread2 = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingBread2 && !spawn5used && spawn4used && !isSpawningBread2)
        {
            isSpawningBread2 = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingBread2 && !spawn4used && spawn3used && !isSpawningBread2)
        {
            isSpawningBread2 = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingBread2 && !spawn3used && spawn2used && !isSpawningBread2)
        {
            isSpawningBread2 = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingBread2 && !spawn2used && spawn1used && !isSpawningBread2)
        {
            isSpawningBread2 = true;
            yield return new WaitForSeconds(1f);
    ...
    private IEnumerator SpawnMeat()
    {
        ...
        if (isTouchingMeat && !spawn10used && spawn9used && !isSpawningMeat)
        {
            isSpawningMeat = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingMeat && !spawn9used && spawn8used && !isSpawningMeat)
        {
            isSpawningMeat = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingMeat && !spawn8used && spawn7used && !isSpawningMeat)
        {
            isSpawningMeat = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingMeat && !spawn7used && spawn6used && !isSpawningMeat)
        {
            isSpawningMeat = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingMeat && !spawn6used && spawn5used && !isSpawningMeat)
        {
            isSpawningMeat = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingMeat && !spawn5used && spawn4used && !isSpawningMeat)
        {
            isSpawningMeat = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingMeat && !spawn4used && spawn3used && !isSpawningMeat)
        {
            isSpawningMeat = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingMeat && !spawn3used && spawn2used && !isSpawningMeat)
        {
            isSpawningMeat = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingMeat && !spawn2used && spawn1used && !isSpawningMeat)
        {
            isSpawningMeat = true;
            yield return new WaitForSeconds(1f);
    ...
    private IEnumerator SpawnCheese()
    {
        ...
        if (isTouchingCheese && !spawn10used && spawn9used && !isSpawningCheese)
        {
        ...
        if (isTouchingCheese && !spawn9used && spawn8used && !isSpawningCheese)
        {
            isSpawningCheese = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingCheese && !spawn8used && spawn7used && !isSpawningCheese)
        {
            isSpawningCheese = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingCheese && !spawn7used && spawn6used && !isSpawningCheese)
        {
            isSpawningCheese = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingCheese && !spawn6used && spawn5used && !isSpawningCheese)
        {
            isSpawningCheese = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingCheese && !spawn5used && spawn4used && !isSpawningCheese)
        {
            isSpawningCheese = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingCheese && !spawn4used && spawn3used && !isSpawningCheese)
        {
            isSpawningCheese = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingCheese && !spawn3used && spawn2used && !isSpawningCheese)
        {
            isSpawningCheese = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingCheese && !spawn2used && spawn1used && !isSpawningCheese)
        {
            isSpawningCheese = true;
            yield return new WaitForSeconds(1f);
    ...
    private IEnumerator SpawnLettuce()
    {
        ...
        if (isTouchingLettuce && !spawn10used && spawn9used && !isSpawningLettuce)
        {
        ...
        if (isTouchingLettuce && !spawn9used && spawn8used && !isSpawningLettuce)
        {
            isSpawningLettuce = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingLettuce && !spawn8used && spawn7used && !isSpawningLettuce)
        {
            isSpawningLettuce = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingLettuce && !spawn7used && spawn6used && !isSpawningLettuce)
        {
            isSpawningLettuce = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingLettuce && !spawn6used && spawn5used && !isSpawningLettuce)
        {
            isSpawningLettuce = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingLettuce && !spawn5used && spawn4used && !isSpawningLettuce)
        {
            isSpawningLettuce = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingLettuce && !spawn4used && spawn3used && !isSpawningLettuce)
        {
            isSpawningLettuce = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingLettuce && !spawn3used && spawn2used && !isSpawningLettuce)
        {
            isSpawningLettuce = true;
            yield return new WaitForSeconds(1f);
        ...
        if (isTouchingLettuce && !spawn2used && spawn1used && !isSpawningLettuce)
        {
            isSpawningLettuce = true;
            yield return new WaitForSeconds(1f);
